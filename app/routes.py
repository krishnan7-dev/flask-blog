...
from app import app, db, hasher, mail
...
def register():
    ...
    if form.validate_on_submit():
        hashed_pw = hasher.generate_password_hash(password=form.password.data).decode('utf-8')
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        hashed_password = hasher.generate_password_hash(form.password.data)
